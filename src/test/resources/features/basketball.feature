Feature:
  #Describing the background and purpose of the features
  Background: Testing the functionality of the account-creation page of the official basketballengland page
    ...
    #Creating a scenario outline to describe and create insertable methods
    Scenario Outline: Creating account on basketballengland
      ...
      #All methods and the corresponding values being inserted in each one
      Examples:
